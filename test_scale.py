...
class Predictor(object):
    ...
    def predict(self, filename='', scales=[0.8, 1, 1.2, 1.4, 1.6, 1.8, 2, 2.2, 2.4]):
        self.model.eval()
...
def main():
    ...
    parser.add_argument('--filename', default='no_name', type=str, help='input filename')
